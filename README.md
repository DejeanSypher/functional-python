# Functional Python [![](https://github.com/DejeanSypher/functional-python/workflows/tests/badge.svg)](https://github.com/DejeanSypher/functional-python/actions?query=workflow%3Atests)
